...
```javascript
import FLOAT16_CBRT_EPSILON from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-cbrt-eps@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-float16-cbrt-eps/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/constants-float16-cbrt-eps/actions/workflows/test.yml?query=branch:v0.1.0
